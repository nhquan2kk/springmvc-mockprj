...
<head>
	...
	<link rel="stylesheet" type="text/css" href="https://fonts.googleapis.com/css2?family=Overpass&display=swap">
...
<nav class="navbar navbar-expand-md navbar-light" id="navbar_sticky">
  <div class="container-xl">
    <a class="navbar-brand fs-2 p-0 fw-bold text-white m-0 me-5" href="index.html"><i class="fa fa-youtube-play me-1 col_red"></i> Play Show </a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <ul class="navbar-nav mb-0 ms-auto">
		  ...
		  <li class="nav-item">
          <a class="nav-link" href="account.html"><i class="fa fa-user fs-4 align-middle me-1 lh-1 col_red"></i> Account </a>
        </li>
      </ul>
    </div>
  </div>
   ...
   <form action="${pageContext.request.contextPath}/contact/submit" method="post">
    ...
    <div class="col-md-6">
	 <div class="contact_2l">
	     <div class="blog_1d3i row">
		  <div class="col-md-6">
		   <div class="blog_1d3il">
		    <input placeholder="Enter Name" class="form-control" type="text" id="name" name="name">
		   </div>
		  </div>
		  <div class="col-md-6">
		   <div class="blog_1d3il">
		    <input placeholder="Enter Email" class="form-control" type="email" id="email" name="email">
		   </div>
		  </div>
		 </div>
		 <div class="blog_1d3i  row">
		  <div class="col-md-12">
		   <div class="blog_1d3il">
		    <input placeholder="Title" class="form-control mt-4" type="text" id="title" name="title">
		   </div>
		  </div>
		 ...
		 <div class="blog_1d3i  row">
		  <div class="col-md-12">
		   <div class="blog_1d3il">
		    <textarea  placeholder="Write a Message" class="form-control form_text mt-4" id="detail" name="detail"></textarea>
			<input type="submit" value="Send Report" class="button_1">
		   </div>
		  </div>
	...
	<div class="col-md-6">
	 <div class="contact_2r">
	   <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d9122.7421266553!2d108.26445044378892!3d15.980135536787694!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x314210f2d038af0f%3A0x51c64b1130497f99!2zRlBUIENvbXBsZXggxJDDoCBO4bq1bmc!5e0!3m2!1svi!2s!4v1722567407259!5m2!1svi!2s" height="420" style="border:0; width:100%;" allowfullscreen=""></iframe>
	 </div>
	</div>
   </div>
 </div>
	 ...
	 <div class="row contact_h_1">
		  ...
		  <div class="contact_h_1l">
		    <div class="grid clearfix">
				  <figure class="effect-jazz mb-0">
					<a href="#"><img src="${pageContext.request.contextPath}/assets/img/25.jpg" class="w-100" alt="banner"></a>
				  </figure>
			  </div>
		  </div>
		</div>
		<div class="col-md-6">
		  <div class="contact_h_1r bg-white">
		   ...
		   <p class="mb-3">We can assist at any time</p>
...
<section id="footer_b">
	...
	<div class="col-md-12">
	  <p class="mb-0 text-muted">© 2013 Your Website Name. All Rights Reserved | Design by <a class="col_red" href="http://www.templateonweb.com">TemplateOnWeb</a></p>
	</div>
	</div>
	</div>
</section>
